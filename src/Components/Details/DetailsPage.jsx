  ...
  return (
    Object.keys(recipeData).length !== 0 && (
      <div className="w-full flex flex-col items-center text-white">
        <div className="w-[90%] my-8 flex gap-4 items-center justify-center bg-">
          ...
          <div className="w-[50%] h-full flex flex-col items-center gap-4">
        ...
        <div className="ingredients w-[90%] flex flex-col items-center gap-8 py-12">
          ...
          <div className="flex items-center flex-wrap gap-4">
            {recipeData.extendedIngredients.map((ing, idx) => {
              return (
                <div
                  className="ing rounded-[50%] w-[20rem] h-[20rem] flex flex-col items-center gap-8 bg-white py-4 text-backgroundColor"
                  key={ing.id}
                  id={ing.id}
                >
                  ...
                  <p className="text-2xl font-semibold text-pinkLight">{ing.nameClean}</p>
                  <div className="flex items-center gap-2 text-pinkLight">
                    <p>Amount: </p>
                    <p>
